...
function search(q){
  ...
  const urlAutocomplete = `http://api.giphy.com/v1/gifs/search?api_key=${appikey}&q=${q}&limit=12`
...
buscadorSuggest.addEventListener("keyup", () => {
    ...
    var urlSuggestions = `http://api.giphy.com/v1/gifs/search/tags?api_key=LcybAN2NSdMZKawiiuEU0m7lgBTrf52c&q=${qq}&limit=6`;
